...
System.namespace("Slipe.Client.Vehicles", function (namespace)
  ...
  namespace.class("Trailer", function (namespace)
    ...
    getTowingVehicle = function (this)
      return SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleTowingVehicle(this.element), SlipeClientVehicles.BaseVehicle)
    end
    setTowingVehicle = function (this, value)
      AttachTo4(this, value)
    end
    op_Explicit = function (vehicle)
      if System.is(SlipeClientVehicles.VehicleModel.FromId(vehicle:getModel()), SlipeClientVehicles.TrailerModel) then
    ...
    class = {
      ...
      __metadata__ = function (out)
        return {
          properties = {
            { "TowingVehicle", 0x106, out.Slipe.Client.Vehicles.BaseVehicle, getTowingVehicle, setTowingVehicle }
          },
          methods = {
            { ".ctor", 0x106, __ctor1__, out.Slipe.MtaDefinitions.MtaElement },
            { ".ctor", 0x206, __ctor2__, out.Slipe.Client.Vehicles.TrailerModel, System.Numerics.Vector3 },
            { ".ctor", 0x606, __ctor3__, out.Slipe.Client.Vehicles.TrailerModel, System.Numerics.Vector3, System.Numerics.Vector3, System.String, System.Int32, System.Int32 },
            { "AttachTo", 0x186, AttachTo4, out.Slipe.Client.Vehicles.BaseVehicle, System.Boolean }
          },
          events = {
            { "OnAttach", 0x6, System.Delegate(class, out.Slipe.Client.Vehicles.Events.OnAttachEventArgs, System.Void) },
            { "OnDetach", 0x6, System.Delegate(class, out.Slipe.Client.Vehicles.Events.OnDetachEventArgs, System.Void) }
          },
          class = { 0x6 }
        }
      end
