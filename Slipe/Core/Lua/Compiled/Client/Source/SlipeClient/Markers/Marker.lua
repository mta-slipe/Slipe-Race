...
System.namespace("Slipe.Client.Markers", function (namespace)
  -- <summary>
  ...
  namespace.class("Marker", function (namespace)
    ...
    __ctor2__ = function (this, position, type, color, size)
      __ctor1__(this, SlipeMtaDefinitions.MtaClient.CreateMarker(position.X, position.Y, position.Z, type:ToEnumString(SlipeSharedMarkers.MarkerType), size, color:getR(), color:getG(), color:getB(), color:getA()))
    end
    -- <summary>
