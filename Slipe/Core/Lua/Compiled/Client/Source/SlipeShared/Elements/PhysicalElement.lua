...
System.namespace("Slipe.Shared.Elements", function (namespace)
  ...
  namespace.class("PhysicalElement", function (namespace)
    ...
    getCollisionShape = function (this)
      return SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetElementColShape(this.element), SlipeSharedCollisionShapes.CollisionShape)
    end
