...
System.namespace("Slipe.Server.Vehicles", function (namespace)
  ...
  namespace.class("Helicopter", function (namespace)
    ...
    op_Explicit = function (vehicle)
      if System.is(SlipeServerVehicles.VehicleModel.FromId(vehicle:getModel()), SlipeServerVehicles.HelicopterModel) then
      ...
      __metadata__ = function (out)
        return {
          methods = {
            ...
            { ".ctor", 0x206, __ctor2__, out.Slipe.Server.Vehicles.HelicopterModel, System.Numerics.Vector3 },
            { ".ctor", 0x606, __ctor3__, out.Slipe.Server.Vehicles.HelicopterModel, System.Numerics.Vector3, System.Numerics.Vector3, System.String, System.Int32, System.Int32 }
          },
          class = { 0x6 }
        }
      end
