...
System.namespace("Slipe.Server.Vehicles", function (namespace)
  ...
  namespace.class("Trailer", function (namespace)
    ...
    getTowingVehicle = function (this)
      return SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleTowingVehicle(this.element), SlipeServerVehicles.Vehicle)
    end
